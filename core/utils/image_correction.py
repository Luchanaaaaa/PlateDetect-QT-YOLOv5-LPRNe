...
class ImageCorrection(object):
    ...
    @staticmethod
    def get_hough_lines_p(img: np.ndarray, rho=1, theta=np.pi / 180, threshold=50, max_angle=45,
                          max_lines=200, minLineLength=5, maxLineGap=10, thickness=2, vis=False):
        """
...
if __name__ == "__main__":
    # image_dir = "../../data/plate4/沪AF23022_00743_000.jpg"  # 测试图片
    # image_dir = "../../data/plate4/沪AF63110_00152_000.jpg"  # 测试图片
    image_dir = "../../data/plate4/"  # 测试图片
