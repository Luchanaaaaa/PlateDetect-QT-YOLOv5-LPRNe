...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u"resourse/icon.webp", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        self.BackGroundLabel_2.setPixmap(QPixmap(u"resourse/background.webp"))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"LoginPage", None))
        ...
        self.AutoLogInCheckBox.setText(QCoreApplication.translate("MainWindow", u"Remember username", None))
        self.SignUpLinkLabel.setText(QCoreApplication.translate("MainWindow", u"Register account", None))
    # retranslateUi
